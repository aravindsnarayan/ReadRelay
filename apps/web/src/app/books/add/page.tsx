        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="text-center mb-8">
            ...
            <Text color="secondary" className="text-lg max-w-2xl mx-auto">
              Share your book with the ReadRelay community. Scan the ISBN or
              ...
              <ul className="space-y-2 text-blue-800">
                <li className="flex items-start">
                  ...
                  <Text className="text-sm">
                    Use the camera scanner to quickly capture ISBN barcodes and
                ...
                <li className="flex items-start">
                  <span className="font-medium mr-2">📝</span>
                  <Text className="text-sm">
                    Add a detailed description to help others understand what
                    makes your book special
                  </Text>
                </li>
                <li className="flex items-start">
                  <span className="font-medium mr-2">🏷️</span>
                  <Text className="text-sm">
                    Use tags to categorize your book (fiction, non-fiction,
                    mystery, romance, etc.)
                  </Text>
                </li>
                <li className="flex items-start">
                  <span className="font-medium mr-2">🔄</span>
                  <Text className="text-sm">
                    Choose your preferred exchange type: borrow temporarily,
                    swap permanently, or give away
                  </Text>
                </li>
              </ul>
            </div>
