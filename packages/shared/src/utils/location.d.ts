...
export declare const calculateBounds: (
  center: Coordinates,
  radiusKm: number
) => LocationBounds;
export declare const generateRadiusQuery: (
  center: Coordinates,
  radiusKm: number,
  latColumn?: string,
  lngColumn?: string
) => string;
export declare const generateDistanceQuery: (
  center: Coordinates,
  latColumn?: string,
  lngColumn?: string
) => string;
export declare const isValidCoordinate: (coord: Coordinates) => boolean;
export declare const formatCoordinates: (
  coord: Coordinates,
  precision?: number
) => string;
export declare const parseCoordinates: (
  coordString: string
) => Coordinates | null;
...
export declare const calculateCenterPoint: (
  coordinates: Coordinates[]
) => Coordinates;
export declare const isWithinBounds: (
  point: Coordinates,
