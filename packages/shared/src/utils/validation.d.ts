...
export declare const profileUpdateSchema: z.ZodObject<{
    ...
    preferred_meeting_locations: z.ZodOptional<z.ZodOptional<z.ZodArray<z.ZodString, "many">>>;
    phone: z.ZodOptional<z.ZodOptional<z.ZodString>>;
    notification_preferences: z.ZodOptional<z.ZodOptional<z.ZodObject<{
        email: z.ZodDefault<z.ZodBoolean>;
        push: z.ZodDefault<z.ZodBoolean>;
        sms: z.ZodDefault<z.ZodBoolean>;
    }, "strip", z.ZodTypeAny, {
...
export declare const bookConditionSchema: z.ZodEnum<["excellent", "good", "fair", "poor"]>;
export declare const exchangeTypeSchema: z.ZodEnum<["borrow", "swap", "give_away"]>;
export declare const availabilityStatusSchema: z.ZodEnum<["available", "exchanging", "unavailable"]>;
...
export declare const exchangeStatusSchema: z.ZodEnum<["pending", "accepted", "rejected", "in_progress", "completed", "cancelled"]>;
...
export declare const exchangeUpdateSchema: z.ZodObject<{
    ...
    status: z.ZodOptional<z.ZodEnum<["pending", "accepted", "rejected", "in_progress", "completed", "cancelled"]>>;
}, "strip", z.ZodTypeAny, {
    book_id?: string | undefined;
    status?: "pending" | "accepted" | "rejected" | "in_progress" | "completed" | "cancelled" | undefined;
    exchange_type?: "borrow" | "swap" | "give_away" | undefined;
    meeting_datetime?: string | undefined;
    meeting_location?: string | undefined;
    notes?: string | undefined;
...
export declare const messageTypeSchema: z.ZodEnum<["text", "template", "system", "location"]>;
export declare const messageSchema: z.ZodObject<{
    exchange_id: z.ZodString;
    receiver_id: z.ZodString;
    content: z.ZodString;
    message_type: z.ZodDefault<z.ZodEnum<["text", "template", "system", "location"]>>;
    template_data: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodAny>>;
}, "strip", z.ZodTypeAny, {
    exchange_id: string;
    receiver_id: string;
    content: string;
    message_type: "template" | "text" | "system" | "location";
    template_data?: Record<string, any> | undefined;
}, {
    exchange_id: string;
    receiver_id: string;
    content: string;
    message_type?: "template" | "text" | "system" | "location" | undefined;
    template_data?: Record<string, any> | undefined;
}>;
...
export declare const bookSearchSchema: z.ZodEffects<z.ZodObject<{
    query: z.ZodOptional<z.ZodString>;
    author: z.ZodOptional<z.ZodString>;
    genre: z.ZodNullable<z.ZodOptional<z.ZodString>>;
    condition: z.ZodOptional<z.ZodEnum<["excellent", "good", "fair", "poor"]>>;
    exchange_type: z.ZodOptional<z.ZodEnum<["borrow", "swap", "give_away"]>>;
    availability_status: z.ZodOptional<z.ZodEnum<["available", "exchanging", "unavailable"]>>;
    ...
    author?: string | undefined;
    availability_status?: "available" | "exchanging" | "unavailable" | undefined;
    condition?: "excellent" | "good" | "fair" | "poor" | undefined;
    exchange_type?: "borrow" | "swap" | "give_away" | undefined;
...
export declare const safeValidateInput: <T>(schema: z.ZodSchema<T>, data: unknown) => {
    success: true;
    data: T;
} | {
    success: false;
