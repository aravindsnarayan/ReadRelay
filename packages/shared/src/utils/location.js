...
export const calculateBounds = (center, radiusKm) => {
    const R = 6371; // Earth's radius in kilometers
...
export const generateRadiusQuery = (center, radiusKm, latColumn = 'location_latitude', lngColumn = 'location_longitude') => {
...
export const generateDistanceQuery = (center, latColumn = 'location_latitude', lngColumn = 'location_longitude') => {
    return `
    CASE 
...
export const formatCoordinates = (coord, precision = 6) => {
...
export const calculateCenterPoint = (coordinates) => {
...
export var LocationPermission;
(function (LocationPermission) {
    LocationPermission["GRANTED"] = "granted";
    LocationPermission["DENIED"] = "denied";
    LocationPermission["PROMPT"] = "prompt";
    LocationPermission["NOT_SUPPORTED"] = "not_supported";
