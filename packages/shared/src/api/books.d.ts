...
export declare const searchBooks: (
  searchParams: BookSearchInput
) => Promise<BooksResult>;
export declare const searchBooksByLocation: (
  center: Coordinates,
  radiusKm?: number,
  limit?: number,
  offset?: number
...
export declare const uploadBookCover: (
  bookId: string,
  file: File
) => Promise<{
  success: boolean;
...
export declare const getBookByISBN: (isbn: string) => Promise<{
  success: boolean;
  book?: ExternalBookData;
  error?: string;
}>;
export declare const searchExternalBooks: (
  query: string,
  limit?: number
) => Promise<{
  success: boolean;
...
export declare const getSimilarBooks: (
  bookId: string,
  limit?: number
) => Promise<BooksResult>;
